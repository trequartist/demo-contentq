      ...
      <div className="relative w-full max-w-4xl max-h-[90vh] overflow-hidden rounded-3xl bg-white shadow-2xl">
        ...
        <div className="flex items-center justify-between border-b border-gray-100 p-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              {selectedTopic ? 'Select a subtopic to continue' : 'Pick from our curated content calendar'}
            </p>
          </div>
          <button
            onClick={onClose}
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 mb-3">{subtopic.hook}</p>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex flex-wrap gap-1 mt-2">
                          {subtopic.keyPoints.slice(0, 3).map((point, idx) => (
        ...
        <div className="border-t border-gray-100 p-6">
          <p className="text-xs text-gray-500 text-center">
            {selectedTopic
              ? `${selectedTopic.subtopics.length} angles available for this topic`
              : `${topics.length} topics available in your content calendar`}
          </p>
        </div>
      </div>
    </div>
